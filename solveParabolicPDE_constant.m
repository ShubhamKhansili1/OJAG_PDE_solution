function [e, t, x]=solveParabolicPDE_constant(N, M, T, a, kappa, K, sigma, gamma, f)
    % solveParabolicPDE solves a parabolic PDE with nonlinear F.
    %
    % INPUTS:
    % N      : Number of spatial divisions
    % M      : Number of temporal divisions
    % T      : Total time
    ...
    t = linspace(0, T, M+1); % Temporal grid
    ...
    % The control i.e the linear connection is stored in the B matrix_linear
      ...
      for n = 1:M
        ...
        e(:, n+1) = e(:, n) + dt * (A_times_e +F(t,gamma_vec(:),e(:,n)) -K*C_times_e);
      end
end
